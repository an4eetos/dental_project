...
func helpText() string {
	return "Отправьте фото или короткое видео зубов.\n\n" +
		"• Фото: прикрепите снимок как «Фото» (не стикер).\n" +
		"• Видео: отправьте как «Видео» или короткий видеофайл.\n\n" +
...
func submissionErrorText(err error) string {
	...
	if errors.Is(err, domainerrors.ErrSubmissionMediaTooLarge) {
		return "Файл слишком большой. Отправьте фото меньшего размера или более короткое видео."
	}
